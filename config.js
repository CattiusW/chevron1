window.CONFIG = {
  macros: [
    ...
    { category: 'Programming', name: 'StackOverflow', icon: 'stackoverflow', url: 'https://stackoverflow.com', normalisedURL: 'stackoverflow.com', triggers: ['st', 'so', 'stack', 'stackoverflow'], key: 'KeyS', commands: { search: { template: '{@}/search?q={$}' }, go: { template: '{@}/questions/{$}', description: 'gotoquestion' } }, bgColor: { type: 'gradient', gradientType: 'linear', colors: ['#e87922', '#ffbe25'], stops: [0, 100] }, textColor: '#212121', pinned: true },
    ...
    { category: 'Music', name: 'spotify', icon: 'spotify', url: 'https://spotify.com', normalisedURL: 'spotify.com', triggers: ['music', 'sp', 'sfy', 'spo', 'spotify'], key: 'KeyP', commands: { search: { template: '{@}/search/{$}' }, go: { template: '{@}/track/{$}', description: 'gototrack' } }, bgColor: { type: 'solid', color: '#1ccc5b' }, textColor: '#000', pinned: true },
    { category: 'Communication', name: 'Outlook', icon: 'outlook', url: 'https://outlook.office365.com', normalisedURL: 'outlook.office365.com', triggers: ['o', 'ol', 'mail', 'm'], key: 'KeyM', bgColor: { type: 'gradient', gradientType: 'linear', angle: 45, colors: ['#df493b', '#df493b'], stops: [50, 100] }, textColor: '#e8e8e8', pinned: true },
    { category: 'Work', name: 'GoogleDrive', triggers: ['gd', 'drive', 'gdrive', 'google'], icon: 'gdrive', url: 'https://google.com', normalisedURL: '://google.com', bgColor: { type: 'gradient', angle: 70, gradientType: 'linear', colors: ['#2684fc', '#00ac47', '#ffba00'], stops: [0, 50, 100] }, textColor: '#fff', pinned: true },
    ...
    { category: 'Education', name: 'Wikipedia', icon: 'wikipedia', triggers: ['w', 'wiki', 'wikipedia'], url: 'https://wikipedia.org', normalisedURL: 'wikipedia.org', commands: { search: { template: '{@}/wiki/Special:Search/{%s}' }, go: { template: '{@}/wiki/{$}' } }, bgColor: { type: 'gradient', gradientType: 'linear', colors: ['#e1e1e3', '#bbb'], stops: [60, 100] }, textColor: '#000', pinned: true },
    ...
    { category: 'To Do', name: 'To Do', triggers: ['todo', 'td', 't', 'to do', 'tpdo'], url: 'https://classroom.google.com/a/not-turned-in/all', normalisedURL: 'classroom.google.com/a/not-turned-in/all', bgColor: { type: 'solid', color: '#e37151' }, textColor: '#e8e8e8' },
